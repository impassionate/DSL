...
def translate_java_to_python(java_code, api_key):
    ...
    prompt = f"Translate the following python code to MATLAB(return MATLAB code only) :\n\n{java_code}\n"
...
# usage:
api_key = "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"  # Remember to use your own key
results = extract_translate_and_evaluate("test2.docx", api_key)
print(results)
